...
export const BookmarkIcon: React.FC<{ solid?: boolean; className?: string }> = ({ solid, className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-6 w-6"} viewBox="0 0 20 20" fill={solid ? "currentColor" : "none"} stroke="currentColor" strokeWidth="1.5">
...
export const SparklesIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m11-1V6a2 2 0 00-2-2H9a2 2 0 00-2 2v10a2 2 0 002 2h5a2 2 0 002-2z" />
    </svg>
);
...
export const TranslateIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className={className || "h-6 w-6"}>
